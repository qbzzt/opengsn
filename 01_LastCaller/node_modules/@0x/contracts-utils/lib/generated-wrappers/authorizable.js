...
var AuthorizableEvents;
(function (AuthorizableEvents) {
    AuthorizableEvents["AuthorizedAddressAdded"] = "AuthorizedAddressAdded";
    AuthorizableEvents["AuthorizedAddressRemoved"] = "AuthorizedAddressRemoved";
    AuthorizableEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(AuthorizableEvents = exports.AuthorizableEvents || (exports.AuthorizableEvents = {}));
...
var AuthorizableContract = /** @class */ (function (_super) {
    ...
    function AuthorizableContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = AuthorizableContract.deployedBytecode; }
        var _this = _super.call(this, 'Authorizable', AuthorizableContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(AuthorizableContract.ABI(), _this._web3Wrapper);
        AuthorizableContract.ABI().forEach(function (item, index) {
    ...
    AuthorizableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, AuthorizableContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    AuthorizableContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, AuthorizableContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    AuthorizableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("Authorizable successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new AuthorizableContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    AuthorizableContract.ABI = function () {
        var abi = [
            {
                inputs: [],
                outputs: [],
    ...
    AuthorizableContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, AuthorizableContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    AuthorizableContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = AuthorizableContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    AuthorizableContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    AuthorizableContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    AuthorizableContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    AuthorizableContract.prototype.addAuthorizedAddress = function (target) {
        var self = this;
    ...
    ;
    AuthorizableContract.prototype.authorities = function (index_0) {
        var self = this;
    ...
    ;
    AuthorizableContract.prototype.authorized = function (index_0) {
        var self = this;
    ...
    * @returns Array of authorized addresses.
     */
    AuthorizableContract.prototype.getAuthorizedAddresses = function () {
        var self = this;
    ...
    ;
    AuthorizableContract.prototype.owner = function () {
        var self = this;
     ...
     */
    AuthorizableContract.prototype.removeAuthorizedAddress = function (target) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    AuthorizableContract.prototype.removeAuthorizedAddressAtIndex = function (target, index) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    AuthorizableContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
     ...
     */
    AuthorizableContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, AuthorizableEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, AuthorizableContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    AuthorizableContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    AuthorizableContract.prototype.unsubscribeAll = function () {
     ...
     */
    AuthorizableContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, AuthorizableContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    AuthorizableContract.contractName = 'Authorizable';

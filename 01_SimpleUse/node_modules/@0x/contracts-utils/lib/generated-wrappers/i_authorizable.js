...
var IAuthorizableEvents;
(function (IAuthorizableEvents) {
    IAuthorizableEvents["AuthorizedAddressAdded"] = "AuthorizedAddressAdded";
    IAuthorizableEvents["AuthorizedAddressRemoved"] = "AuthorizedAddressRemoved";
    IAuthorizableEvents["OwnershipTransferred"] = "OwnershipTransferred";
})(IAuthorizableEvents = exports.IAuthorizableEvents || (exports.IAuthorizableEvents = {}));
...
var IAuthorizableContract = /** @class */ (function (_super) {
    ...
    function IAuthorizableContract(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) {
        if (deployedBytecode === void 0) { deployedBytecode = IAuthorizableContract.deployedBytecode; }
        var _this = _super.call(this, 'IAuthorizable', IAuthorizableContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode) || this;
        _this._methodABIIndex = {};
        utils_1.classUtils.bindAll(_this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
        _this._subscriptionManager = new base_contract_1.SubscriptionManager(IAuthorizableContract.ABI(), _this._web3Wrapper);
        IAuthorizableContract.ABI().forEach(function (item, index) {
    ...
    IAuthorizableContract.deployFrom0xArtifactAsync = function (artifact, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                ...
                return [2 /*return*/, IAuthorizableContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly)];
            });
        });
    };
    IAuthorizableContract.deployWithLibrariesFrom0xArtifactAsync = function (artifact, libraryArtifacts, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, IAuthorizableContract._deployLibrariesAsync(artifact, libraryArtifacts, new web3_wrapper_1.Web3Wrapper(provider), txDefaults)];
                    case 1:
    ...
    IAuthorizableContract.deployAsync = function (bytecode, abi, supportedProvider, txDefaults, logDecodeDependencies) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        txReceipt = _a.sent();
                        utils_1.logUtils.log("IAuthorizable successfully deployed at " + txReceipt.contractAddress);
                        contractInstance = new IAuthorizableContract(txReceipt.contractAddress, provider, txDefaults, logDecodeDependencies);
     ...
     */
    IAuthorizableContract.ABI = function () {
        var abi = [
            {
                anonymous: false,
                inputs: [
    ...
    IAuthorizableContract._deployLibrariesAsync = function (artifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses) {
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, IAuthorizableContract._deployLibrariesAsync(libraryArtifact, libraryArtifacts, web3Wrapper, txDefaults, libraryAddresses)];
                    case 5:
                        // Deploy any dependent libraries used by this library.
                        _g.sent();
    ...
    IAuthorizableContract.prototype.getFunctionSignature = function (methodName) {
        var index = this._methodABIIndex[methodName];
        var methodAbi = IAuthorizableContract.ABI()[index]; // tslint:disable-line:no-unnecessary-type-assertion
        var functionSignature = base_contract_1.methodAbiToFunctionSignature(methodAbi);
        return functionSignature;
    };
    IAuthorizableContract.prototype.getABIDecodedTransactionData = function (methodName, callData) {
    ...
    IAuthorizableContract.prototype.getABIDecodedReturnData = function (methodName, callData) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
    ...
    IAuthorizableContract.prototype.getSelector = function (methodName) {
        var functionSignature = this.getFunctionSignature(methodName);
        var self = this;
        var abiEncoder = self._lookupAbiEncoder(functionSignature);
     ...
     */
    IAuthorizableContract.prototype.addAuthorizedAddress = function (target) {
        var self = this;
    ...
    * @returns Array of authorized addresses.
     */
    IAuthorizableContract.prototype.getAuthorizedAddresses = function () {
        var self = this;
     ...
     */
    IAuthorizableContract.prototype.removeAuthorizedAddress = function (target) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    IAuthorizableContract.prototype.removeAuthorizedAddressAtIndex = function (target, index) {
        var self = this;
        assert_1.assert.isString('target', target);
     ...
     */
    IAuthorizableContract.prototype.transferOwnership = function (newOwner) {
        var self = this;
     ...
     */
    IAuthorizableContract.prototype.subscribe = function (eventName, indexFilterValues, callback, isVerbose, blockPollingIntervalMs) {
        if (isVerbose === void 0) { isVerbose = false; }
        assert_1.assert.doesBelongToStringEnum('eventName', eventName, IAuthorizableEvents);
        ...
        var subscriptionToken = this._subscriptionManager.subscribe(this.address, eventName, indexFilterValues, IAuthorizableContract.ABI(), callback, isVerbose, blockPollingIntervalMs);
     ...
     */
    IAuthorizableContract.prototype.unsubscribe = function (subscriptionToken) {
        this._subscriptionManager.unsubscribe(subscriptionToken);
    };
    /**
     * Cancels all existing subscriptions
     */
    IAuthorizableContract.prototype.unsubscribeAll = function () {
     ...
     */
    IAuthorizableContract.prototype.getLogsAsync = function (eventName, blockRange, indexFilterValues) {
        return __awaiter(this, void 0, void 0, function () {
            var logs;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        assert_1.assert.doesConformToSchema('indexFilterValues', indexFilterValues, json_schemas_1.schemas.indexFilterValuesSchema);
                        return [4 /*yield*/, this._subscriptionManager.getLogsAsync(this.address, eventName, blockRange, indexFilterValues, IAuthorizableContract.ABI())];
                    case 1:
                        logs = _a.sent();
    ...
    IAuthorizableContract.contractName = 'IAuthorizable';
...
//# sourceMappingURL=i_authorizable.js.map
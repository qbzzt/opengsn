...
module.exports = {
    event2topic,
    getEip712Signature: async function ({ web3, dataToSign, methodSuffix = '', jsonStringifyRequest = false }) {
     ...
     */
    calculateTransactionMaxPossibleGas: function ({ gasLimits, hubOverhead, relayCallGasLimit, calldataSize, gtxdatanonzero }) {
        return 21000 +
            hubOverhead +

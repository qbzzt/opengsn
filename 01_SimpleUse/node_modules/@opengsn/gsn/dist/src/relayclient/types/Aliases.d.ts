 ...
 */
export declare type PingFilter = (pingResponse: PingResponse, gsnTransactionDetails: GsnTransactionDetails) => void;
export declare type AsyncApprovalData = (relayRequest: RelayRequest) => Promise<PrefixedHexString>;
export declare type RelayFilter = (registeredEventInfo: RelayRegisteredEventInfo) => boolean;
export declare type AsyncScoreCalculator = (relay: RelayRegisteredEventInfo, txDetails: GsnTransactionDetails, failures: RelayFailureInfo[]) => Promise<number>;
